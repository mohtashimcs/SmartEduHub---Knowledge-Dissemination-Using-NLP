    ...
    <>
      <div className="relative flex flex-col w-full">
        <div className="relative">
          ...
          <Input
            className="pl-4 w-full poppins-light bg-slate-300 text-xs rounded-xl placeholder:text-muted-foreground border-2 border-blue-400 text-md focus-visible:ring-0 focus-visible:ring-offset-0 outline-none"
                ...
                >
                  <div className="flex space-x-2 items-center">
                    ...
                    <div className="flex w-full justify-between items-center">
                      ...
                      <Button
                        className="rounded-3xl poppins-semibold text-black  bg-[#87CEEB] border-gray-600 hover:bg-slate-400 hover:text-white"
