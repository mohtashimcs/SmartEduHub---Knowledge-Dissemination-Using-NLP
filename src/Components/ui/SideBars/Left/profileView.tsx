...
export const ProfileView = () => {
  ...
  let userName = useAppSelector((state) => state.profile.name);
  let profilePic = useAppSelector((state) => state.profile.picture);
  let userId = useAppSelector((state) => state.profile.userId);
  setTimeout(() => {
