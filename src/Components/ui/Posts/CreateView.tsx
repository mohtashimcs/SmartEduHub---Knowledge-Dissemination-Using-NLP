      ...
      {loading ? (
        ...
        <Card className="border-2 shadow-2xl bg-[#c2e5f3]  border-gray-500 rounded-3xl">
          <CardHeader>
            <CardTitle>
              <div className="poppins-bold text-gray-900 flex flex-col">
                ...
                <span className="text-sm poppins-light">{userName}</span>
              </div>
            </CardTitle>
          </CardHeader>
          <CardContent className="items-center flex flex-col space-y-6">
            <Textarea
              className={
                "poppins-extralight px-6 placeholder:text-muted-foreground resize-none text-md bg-slate-100 rounded-3xl border-[2px] overflow-hidden border-[#cce9f5] focus-visible:ring-slate-100 focus-visible:ring-0 focus-visible:ring-offset-0  text-gray focus-within:border-blue-700 transition-all duration-2000 text-gray outline-none shadow-inner"
              }
